...
### Diverging bar plot with colors -- transit vs maneuver
...
# data:  maneuver_freq_network[2:3]
# p-value = 0.7973
# alternative hypothesis: two.sided
...
# Pretty much gives same results but is probably more appropriate test

# Anova Table (Type III tests)
# 
# Response: tot_wkdy_adj
#              Sum Sq  Df F value    Pr(>F)    
# (Intercept)     0.0   1  0.0000         1    
# npz_dep         0.0  12  0.0000         1    
# Weekday      1295.6   6  9.3619 5.424e-10 ***
# Residuals   21520.1 933                      
# ---
...
kw_simp201808
# data:  tot_wkdy_adj by Weekday
# Kruskal-Wallis chi-squared = 12.902, df = 6, p-value = 0.04462
...
# no pairwise comparisons sig at alpha=0.05
# Thurs-Mon p=0.08
...
kw_DMP202009
# data:  tot_wkdy_adj by Weekday
# Kruskal-Wallis chi-squared = 20.601, df = 6, p-value = 0.002163
...
# T  1.000 -     -     -     -     -    
# W  0.113 1.000 -     -     -     -    
# Th 0.058 1.000 1.000 -     -     -    
# F  0.954 1.000 1.000 1.000 -     -    
# Sa 1.000 1.000 0.171 0.051 1.000 -    
# Su 1.000 1.000 0.397 0.097 1.000 1.000
...
kw_GMP202201
# data:  tot_wkdy_adj by Weekday
# Kruskal-Wallis chi-squared = 14.347, df = 6, p-value = 0.02599
...
# W  1.00 1.00 -    -    -    -   
# Th 1.00 1.00 1.00 -    -    -   
# F  0.03 0.74 1.00 1.00 -    -   
# Sa 0.71 1.00 1.00 1.00 1.00 -   
# Su 0.35 1.00 1.00 1.00 1.00 1.00
...
kw_MMP202002
# data:  tot_wkdy_adj by Weekday
# Kruskal-Wallis chi-squared = 15.188, df = 6, p-value = 0.01885
...
pairwise.wilcox.test(x = mmp_wkly_mean_adj_tot$tot_wkdy_adj, 
                       ...
                       p.adjust.method = "bonf")
# no pairwise were sig. -- overall probably sig because no presence most days
...
kw_TRMP202105
# data:  tot_wkdy_adj by Weekday
# Kruskal-Wallis chi-squared = 26.85, df = 6, p-value = 0.0001545
...
# T  1.0000 -      -      -      -      -     
# W  0.8378 1.0000 -      -      -      -     
# Th 0.0424 0.2491 1.0000 -      -      -     
# F  0.0078 0.0588 1.0000 1.0000 -      -     
# Sa 0.0250 0.1494 1.0000 1.0000 1.0000 -     
# Su 1.0000 1.0000 1.0000 0.2200 0.0997 0.0811
