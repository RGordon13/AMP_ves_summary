...
# Use "type III" anova for unbalanced design with unequal samples per group
library(car)
library(agricolae)

options(contrasts = c("contr.sum","contr.poly"))
week_tot_t3 <- lm(tot_wkdy_adj ~ npz_dep*Weekday, 
                data = wkly_mean_adj_tot)
anova_t3_tot <- Anova(week_tot_t3, type="III") 

# Anova Table (Type III tests)
# 
# Response: tot_wkdy_adj
#                  Sum Sq  Df F value   Pr(>F)   
# (Intercept)        67.5   1  3.0654 0.080332 . 
# npz_dep           393.1  12  1.4884 0.122526   
# Weekday           449.4   6  3.4029 0.002524 **
# npz_dep:Weekday  2568.0  72  1.6203 0.001242 **
# Residuals       18952.1 861                    
# ---
...
all_ves_light <- all_sites_hp |>
  ...
  #suntools package needs time zone
  mutate(tz_local = case_when(
    Dep == "CGMP_201807_CG" | Dep == "CGMP_201904_CG" | 
      Dep == "SIMP_201808_EP" | Dep == "SIMP_201808_WP" | 
      Dep == "SIMP_201906_EP" | Dep == "SIMP_201906_WP" |
      Dep == "MURAT_202002_MRE" | Dep == "MURAT_202002_MRW" ~ "Etc/GMT-10",
    Dep == "CGMP_201212_CG" | 
      Dep == "SIMP_201212_EP" | Dep == "SIMP_201212_WP" ~ "Etc/GMT-11",
    TRUE ~ "Etc/GMT-8"
  ),
  # and gps coords
  lat_dd = )
