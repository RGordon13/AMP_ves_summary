...
gaps <- data.frame("Gap_start" = c(as.POSIXct("2000-02-21",format="%Y-%m-%d"), #CGMP gap 1 start
                                   ...
                                   as.POSIXct("2000-09-13",format="%Y-%m-%d"), #SIMP gap 2 start
...
dep_startend <- data.frame("dep_start" = c(as.POSIXct("2000-07-01",format="%Y-%m-%d"), #CGMP 201807 start
                                   ...
                                   as.POSIXct("2000-02-20",format="%Y-%m-%d"), #MMP start
...
## Try colors for diverging bar plots
...
#### Plotting total & inside on same plots
