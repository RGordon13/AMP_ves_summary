...
all_sites_hp <- read_csv("C:/Users/rochelle.gordon/Documents/GitHub/AMP_ves_summary/Manuscript_revisions_202510/data/All_sites_tables/hourly_pres_allsites_local.csv")
all_sites_inout <- read_csv("C:/Users/rochelle.gordon/Documents/GitHub/AMP_ves_summary/Manuscript_revisions_202510/data/All_sites_tables/total_ves_ins_out_by_site.csv")

##### Deployment info ###
depinfo <- read_csv("C:/Users/rochelle.gordon/Documents/GitHub/AMP_ves_summary/Manuscript_revisions_202510/data/AMP_deployment_info.csv") |>
...
ggsave(paste0("Manuscript_revisions_202510/figs/", "Total_boxplot_counts_perday_1yr.png"), width=10, height=8,
       units="in", dpi=300)
...
```{r save effort plot}
ggsave(paste0("Manuscript_revisions_202510/figs/", "Total_recording_effort_1yr.png"), width=12, height=8,
       units="in", dpi=300)
...
ggplot() +
  geom_col(data = all_ves_long |> 
         filter(Ves_behav == "total_outside",
               npz_id != "SWCMP",
               npz_id != "MMP",
               npz_id != "GMP"), # To do: also exclude Murat and Geographe - Done RG
        aes(x = npz_id,
...
```{r save div bar fig}
ggsave(paste0("Manuscript_revisions_202510/figs/", "Ins_out_counts_npz_colors_gray18.png"), width=12, height=11,
       units="in", dpi=300)
...
ggplot(data = all_ves_long |>
         filter(Ves_behav == "Inside_transit" |
               ...
               npz_id != "SWCMP",
               npz_id != "GMP",
               npz_id != "MMP")) +  # To do: also exclude Geographe
...
ggsave(paste0("Manuscript_revisions_202510/figs/", "Transit_maneuver_counts_color_npz18.png"), width=12, height=11,
       units="in", dpi=300)
...
# data:  inout_freq_table[3:4]
# p-value = 0.0009995002
...
# 
#            CGMP201807 CGMP201812 CGMP201904 SIMP201808 SIMP201812    10.08.2025
# CGMP201812 1.0000     -          -          -          -         
# CGMP201904 0.8011     1.0000     -          -          -         
# SIMP201808 1.0000     1.0000     0.3807     -          -         
# SIMP201812 0.6619     1.0000     1.0000     0.3238     -         
# SIMP201906 1.0000     0.0788     0.0035     1.0000     0.0035   
# 
...
# 	Pairwise comparisons using Pairwise comparison of proportions (Fisher) 
#UPDATED ANALYSIS # data:  ins_swest out of tot_swest
#             GMP202201 JMP202201 MMP202002 SWCMP202201
# JMP202201    1         -         -         -          
# MMP202002    1         1         -         -          
# SWCMP202201  1         1         1         -          
# TRMP202105   1         1.6e-07   1         1          
...
# CGMP201812 0.2542     -          -          -          -         
# CGMP201904 1.0000     1.0000     -          -          -         
# SIMP201808 1.0000     0.0153     0.0705     -          -         
# SIMP201812 0.1081     1.0000     1.0000     0.0100     -         
# SIMP201906 8.4e-08    0.0627     0.0015     3.9e-09    0.1821  
# 
# P value adjustment method: bonferroni 
...
#Only TRMP has inside vessels, no fisher test or post hoc
...
man_freq_table$prop_maneuver[is.na(man_freq_table$prop_maneuver)] <- 0
fisher.test(man_freq_table[2:3], simulate.p.value = TRUE) #originally maneuver_freq_table but I believe it's meant to be man_freq_table, changed through line 876
...
ins_man <- man_freq_table$Inside_maneuver
names(ins_man) <- man_freq_table$npz_dep
ins_tot <- man_freq_table$total_inside
names(ins_tot) <- man_freq_table$npz_dep
...
wkly_mean_tot_tmpeast <- wkly_mean_adj_tot |>
...
week_aov_tmpeast <- aov(tot_wkdy_adj ~ npz_dep*Weekday, 
                data = wkly_mean_tot_tmpeast)

summary(week_aov_tmpeast)

# sanity check about npz_dep main effect
ggplot(data = wkly_mean_tot_tmpeast, aes(x = npz_dep, y = tot_wkdy_adj)) + 
...
tukey_week_ins_tmpeast <- tidy(TukeyHSD(week_ins_aov_tmpeast)) |>
  filter(adj.p.value <= 0.05)
